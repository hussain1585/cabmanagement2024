package com.expatrio.cabmanagement.config.jwt;

import com.expatrio.cabmanagement.api.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/booking/**").permitAll())
