...
public class CustomerController {
    ...
    public GetCustomerByIdResponse gerCustomerById(@RequestParam int id) {
        ...
        CustomerDTO customerDTO = mapper.entityToDto(customerEntity);
    ...
    public GetAllCustomerResponse getAllCustomers() {
        ...
        List<CustomerDTO> customerDTOList = mapper.entityListToDtoList(customerEntityList);
    ...
    public AddCustomersResponse addCustomerList(@RequestBody AddCustomersRequest addCustomersRequest) {
        ...
        List<CustomerDTO> customers = mapper.entityListToDtoList(customerEntityList);
